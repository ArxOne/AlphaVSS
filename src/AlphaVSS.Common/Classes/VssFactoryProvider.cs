...
namespace ArxOne.Win32.Vss
{
   ...
   public class VssFactoryProvider : IVssFactoryProvider
   {
      ...
      private static string PlatformSpecificAssemblyShortName => $"AlphaVSS.{(RuntimeInformation.ProcessArchitecture switch { Architecture.X64 => "x64", Architecture.X86 => "x86", Architecture.Arm64 => "arm64", _ => throw new PlatformNotSupportedException() })}";
